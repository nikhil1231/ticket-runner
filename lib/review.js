...
function buildReviewPrompt({ ticket, body, board }) {
  ...
  return `You are reviewing a code change an AI made for a tracked ticket, in a git worktree for project ${board.key || board.app || 'unknown'}. Decide whether it correctly and safely implements the ticket.
...
REVIEW_NOTES: <specific fixes,one short approval line>`;
}
