...
function collectStoreData(baseDir) {
  ...
  try {
    ...
    // read replies typed directly on GitHub/Notion — but when the runner parks
...
// ("apply patch") whose raw body — grep/test/build output, or a full unified
...
function summarizeTranscript(text) {
  ...
  // explicit "apply patch" block, or pasted verbatim into a "codex" text
