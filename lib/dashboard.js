...
function listTicketColumns() {
  return 'short_id, project_key, title, kind, status, last_agent, attempts, branch, updated_at';
}
...
function collectStoreData(baseDir) {
  ...
  try {
    ...
    return {
      ...
      byStatus, projectStatus, completed, attention, activity, blockages, needsInfo,
      current: {
        running,
        testing,
        inFlight: running,
