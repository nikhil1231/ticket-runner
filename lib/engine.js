...
// Ordered list of engines to try: the chosen CLI first, then the configured
// fallbacks, de-duplicated. Used for both implementation and review.
...
module.exports = { adapters, QUOTA_RE, buildChain, spawnEngine, tail, readTail };
